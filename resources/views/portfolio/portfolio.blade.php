                ...
                <div class="row align-items-center justify-content-center justify-content-lg-between">
                    <div class="col-lg-6 order-0 order-lg-2">
                        <div class="banner__img text-center text-xxl-end">
                            @foreach ($data as $data)
                                @if (asset('storage/' . $data->img))
                                    <img src="{{ asset('storage/' . $data->img) }}" alt="{{ $data->img }}">
                                @else
                                    <img src="{{ asset('portfolio/assets/img/banner/banner_img.png') }}" alt="">
                                @endif
                        </div>
                    </div>
                    <div class="col-xl-5 col-lg-6">
                        <div class="banner__content">
                            ...
                            <h2 class="title wow fadeInUp" data-wow-delay=".2s"><span>Hello</span> <br>My name
                                {{ $data->name }}.</h2>
                            <p class="wow fadeInUp" data-wow-delay=".4s">{{ $data->text }}</p>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <ul class="about__icons__wrap">
                            <li>
                                <img class="light" src="{{ asset('portfolio/assets/img/icons/xd_light.png') }}"
                                    alt="XD">
                                <img class="dark" src="{{ asset('portfolio/assets/img/icons/xd.png') }}" alt="XD">
                            </li>
                            <li>
                                <img class="light" src="{{ asset('portfolio/assets/img/icons/skeatch_light.png') }}"
                                    alt="Skeatch">
                                <img class="dark" src="{{ asset('portfolio/assets/img/icons/skeatch.png') }}"
                                    alt="Skeatch">
                            </li>
                            <li>
                                <img class="light" src="{{ asset('portfolio/assets/img/icons/illustrator_light.png') }}"
                                    alt="Illustrator">
                                <img class="dark" src="{{ asset('portfolio/assets/img/icons/illustrator.png') }}"
                                    alt="Illustrator">
                            </li>
                            <li>
                                <img class="light" src="{{ asset('portfolio/assets/img/icons/hotjar_light.png') }}"
                                    alt="Hotjar">
                                <img class="dark" src="{{ asset('portfolio/assets/img/icons/hotjar.png') }}"
                                    alt="Hotjar">
                            </li>
                            <li>
                                <img class="light" src="{{ asset('portfolio/assets/img/icons/invision_light.png') }}"
                                    alt="Invision">
                                <img class="dark" src="{{ asset('portfolio/assets/img/icons/invision.png') }}"
                                    alt="Invision">
                            </li>
                            <li>
                                <img class="light" src="{{ asset('portfolio/assets/img/icons/photoshop_light.png') }}"
                                    alt="Photoshop">
                                <img class="dark" src="{{ asset('portfolio/assets/img/icons/photoshop.png') }}"
                                    alt="Photoshop">
                            </li>
                            <li>
                                <img class="light" src="{{ asset('portfolio/assets/img/icons/figma_light.png') }}"
                                    alt="Figma">
                                <img class="dark" src="{{ asset('portfolio/assets/img/icons/figma.png') }}"
                                    alt="Figma">
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="about__content">
                            ...
                            <div class="about__exp">
                                <div class="about__exp__icon">
                                    <img src="{{ asset('portfolio/assets/img/icons/about_icon.png') }}" alt="">
                                </div>
                            ...
                            <div class="services__item">
                                <div class="services__thumb">
                                    <a href="services-details.html"><img
                                            src="{{ asset('storage').'/' .$cat->img}}"
                                            alt=""></a>
                                </div>
                                <div class="services__content">
                                    <div class="services__icon">
                                        <img class="light"
                                            src="{{ asset('portfolio/assets/img/icons/services_light_icon01.png') }}"
                                            alt="">
                                        <img class="dark"
                                            src="{{ asset('portfolio/assets/img/icons/services_icon01.png') }}"
                                            alt="">
                                    </div>
                                    <h3 class="title"><a href="services-details.html">{{$cat->name}}</a></h3>
                                    <p>{{$cat->text}}</p>
                ...
                <div class="row work__process__wrap">
                    <div class="col">
                        <div class="work__process__item">
                            ...
                            <div class="work__process__icon">
                                <img class="light" src="{{ asset('portfolio/assets/img/icons/wp_light_icon01.png') }}"
                                    alt="">
                                <img class="dark" src="{{ asset('portfolio/assets/img/icons/wp_icon01.png') }}"
                                    alt="">
                            </div>
                    ...
                    <div class="col">
                        <div class="work__process__item">
                            ...
                            <div class="work__process__icon">
                                <img class="light" src="{{ asset('portfolio/assets/img/icons/wp_light_icon02.png') }}"
                                    alt="">
                                <img class="dark" src="{{ asset('portfolio/assets/img/icons/wp_icon02.png') }}"
                                    alt="">
                            </div>
                            <div class="work__process__content">
                    ...
                    <div class="col">
                        <div class="work__process__item">
                            ...
                            <div class="work__process__icon">
                                <img class="light" src="{{ asset('portfolio/assets/img/icons/wp_light_icon03.png') }}"
                                    alt="">
                                <img class="dark" src="{{ asset('portfolio/assets/img/icons/wp_icon03.png') }}"
                                    alt="">
                            </div>
                            <div class="work__process__content">
                    ...
                    <div class="col">
                        <div class="work__process__item">
                            ...
                            <div class="work__process__icon">
                                <img class="light" src="{{ asset('portfolio/assets/img/icons/wp_light_icon04.png') }}"
                                    alt="">
                                <img class="dark" src="{{ asset('portfolio/assets/img/icons/wp_icon04.png') }}"
                                    alt="">
                            </div>
                            <div class="work__process__content">
                                ...
                                <div class="portfolio__active">
                                    <div class="portfolio__item">
                                        <div class="portfolio__thumb">
                                            <img src="{{ asset('portfolio/assets/img/portfolio/portfolio_img01.jpg') }}"
                                                alt="">
                                        </div>
                                    ...
                                    <div class="portfolio__item">
                                        <div class="portfolio__thumb">
                                            <img src="{{ asset('portfolio/assets/img/portfolio/portfolio_img02.jpg') }}"
                                                alt="">
                                        </div>
                                        <div class="portfolio__overlay__content">
                                    ...
                                    <div class="portfolio__item">
                                        <div class="portfolio__thumb">
                                            <img src="{{ asset('portfolio/assets/img/portfolio/portfolio_img03.jpg') }}"
                                                alt="">
                                        </div>
                                        <div class="portfolio__overlay__content">
                                    ...
                                    <div class="portfolio__item">
                                        <div class="portfolio__thumb">
                                            <img src="{{ asset('portfolio/assets/img/portfolio/portfolio_img04.jpg') }}"
                                                alt="">
                                        </div>
                                        <div class="portfolio__overlay__content">
                                    ...
                                    <div class="portfolio__item">
                                        <div class="portfolio__thumb">
                                            <img src="{{ asset('portfolio/assets/img/portfolio/portfolio_img05.jpg') }}"
                                                alt="">
                                        </div>
                                        <div class="portfolio__overlay__content">
                                            <span>Web Development</span>
                                    ...
                                    <div class="portfolio__item">
                                        <div class="portfolio__thumb">
                                            <img src="{{ asset('portfolio/assets/img/portfolio/portfolio_img06.jpg') }}"
                                                alt="">
                                        </div>
                                        <div class="portfolio__overlay__content">
                                            <span>Web Development</span>
                                    ...
                                    <div class="portfolio__item">
                                        <div class="portfolio__thumb">
                                            <img src="{{ asset('portfolio/assets/img/portfolio/portfolio_img07.jpg') }}"
                                                alt="">
                                        </div>
                                        <div class="portfolio__overlay__content">
                                            <span>Web Development</span>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <ul class="partner__logo__wrap">
                            <li>
                                <img class="light" src="{{ asset('portfolio/assets/img/icons/partner_light01.png') }}"
                                    alt="">
                                <img class="dark" src="{{ asset('portfolio/assets/img/icons/partner_01.png') }}"
                                    alt="">
                            </li>
                            <li>
                                <img class="light" src="{{ asset('portfolio/assets/img/icons/partner_light02.png') }}"
                                    alt="">
                                <img class="dark" src="{{ asset('portfolio/assets/img/icons/partner_02.png') }}"
                                    alt="">
                            </li>
                            <li>
                                <img class="light" src="{{ asset('portfolio/assets/img/icons/partner_light03.png') }}"
                                    alt="">
                                <img class="dark" src="{{ asset('portfolio/assets/img/icons/partner_03.png') }}"
                                    alt="">
                            </li>
                            <li>
                                <img class="light" src="{{ asset('portfolio/assets/img/icons/partner_light04.png') }}"
                                    alt="">
                                <img class="dark" src="{{ asset('portfolio/assets/img/icons/partner_04.png') }}"
                                    alt="">
                            </li>
                            <li>
                                <img class="light" src="{{ asset('portfolio/assets/img/icons/partner_light05.png') }}"
                                    alt="">
                                <img class="dark" src="{{ asset('portfolio/assets/img/icons/partner_05.png') }}"
                                    alt="">
                            </li>
                            <li>
                                <img class="light" src="{{ asset('portfolio/assets/img/icons/partner_light06.png') }}"
                                    alt="">
                                <img class="dark" src="{{ asset('portfolio/assets/img/icons/partner_06.png') }}"
                                    alt="">
                            </li>
                        </ul>
                    </div>
                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-lg-6 order-0 order-lg-2">
                        <ul class="testimonial__avatar__img">
                            <li><img src="{{ asset('portfolio/assets/img/images/testi_img01.png') }}" alt="">
                            </li>
                            <li><img src="{{ asset('portfolio/assets/img/images/testi_img02.png') }}" alt="">
                            </li>
                            <li><img src="{{ asset('portfolio/assets/img/images/testi_img03.png') }}" alt="">
                            </li>
                            <li><img src="{{ asset('portfolio/assets/img/images/testi_img04.png') }}" alt="">
                            </li>
                            <li><img src="{{ asset('portfolio/assets/img/images/testi_img05.png') }}" alt="">
                            </li>
                            <li><img src="{{ asset('portfolio/assets/img/images/testi_img06.png') }}" alt="">
                            </li>
                            <li><img src="{{ asset('portfolio/assets/img/images/testi_img07.png') }}" alt="">
                            </li>
                        </ul>
                    </div>
                    <div class="col-xl-5 col-lg-6">
                ...
                <div class="row gx-0 justify-content-center">
                        ...
                        <div class="blog__post__item">
                            <div class="blog__post__thumb">
                                <a href="blog-details.html"><img
                                        src="{{ asset('portfolio/assets/img/blog/blog_post_thumb01.jpg') }}"
                                        alt=""></a>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-9">
                        <div class="blog__post__item">
                            <div class="blog__post__thumb">
                                <a href="blog-details.html"><img
                                        src="{{ asset('portfolio/assets/img/blog/blog_post_thumb02.jpg') }}"
                                        alt=""></a>
                                <div class="blog__post__tags">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-9">
                        <div class="blog__post__item">
                            <div class="blog__post__thumb">
                                <a href="blog-details.html"><img
                                        src="{{ asset('portfolio/assets/img/blog/blog_post_thumb03.jpg') }}"
                                        alt=""></a>
                                <div class="blog__post__tags">
