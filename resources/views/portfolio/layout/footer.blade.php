		...
		<!-- JS here -->
        <script src="{{asset('portfolio/assets/js/vendor/jquery-3.6.0.min.js')}}"></script>
        <script src="{{asset('portfolio/assets/js/bootstrap.min.js')}}"></script>
        <script src="{{asset('portfolio/assets/js/isotope.pkgd.min.js')}}"></script>
        <script src="{{asset('portfolio/assets/js/imagesloaded.pkgd.min.js')}}"></script>
        <script src="{{asset('portfolio/assets/js/jquery.magnific-popup.min.js')}}"></script>
        <script src="{{asset('portfolio/assets/js/element-in-view.js')}}"></script>
        <script src="{{asset('portfolio/assets/js/slick.min.js')}}"></script>
        <script src="{{asset('portfolio/assets/js/ajax-form.js')}}"></script>
        <script src="{{asset('portfolio/assets/js/wow.min.js')}}"></script>
        <script src="{{asset('portfolio/assets/js/plugins.js')}}"></script>
